...
## 1. System Overview
Write a short description of the proposed system and its primary purpose.
...
3. The frontend sends an HTTP request to the Express backend.4. The backend validates and processes the request.
